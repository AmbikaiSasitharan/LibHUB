...
namespace LibHub.API.Migrations
{
    ...
    [Migration("20230821214832_AddIsNotifiedAndFineNotifiedToBorrows")]
    partial class AddIsNotifiedAndFineNotifiedToBorrows
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibHub.API.Entities.Book", b =>
                {
                    ...
                    b.Property<float>("CostAtTimeOfPurchase")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("LibHub.API.Entities.Borrow", b =>
                {
                    ...
                    b.Property<bool>("IsFineNotified")
                        .HasColumnType("bit");

                    b.Property<bool>("IsLateNotified")
                        .HasColumnType("bit");
