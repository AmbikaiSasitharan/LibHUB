        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Books_BookDescriptions_BookDescriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookDescriptionGenre", x => new { x.BookDescriptionsId, x.GenresId });
                    table.ForeignKey(
                        name: "FK_BookDescriptionGenre_BookDescriptions_BookDescriptionsId",
                        column: x => x.BookDescriptionsId,
                        principalTable: "BookDescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookDescriptionGenre_Genres_GenresId",
                        column: x => x.GenresId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rating_BookDescriptions_BookDescriptionId",
                        column: x => x.BookDescriptionId,
                        principalTable: "BookDescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfRevewals = table.Column<int>(type: "int", nullable: false),
                    EntryDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedDueDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EntryDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Renewals_Borrows_BorrowId",
                        column: x => x.BorrowId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookDescriptionGenre_GenresId",
                table: "BookDescriptionGenre",
                column: "GenresId");

            migrationBuilder.CreateIndex(
                name: "IX_Books_BookDescriptionId",
                table: "Books",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rating_BookDescriptionId",
                table: "Rating",
                column: "BookDescriptionId");
